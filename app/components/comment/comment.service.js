System.register(['angular2/core', 'angular2/http', 'rxjs/add/operator/map', 'rxjs/add/operator/catch', 'rxjs/add/operator/toPromise'], function(exports_1, context_1) {
    "use strict";
            ...
            CommentService = (function () {
                ...
                CommentService.prototype.getComments = function (postId) {
                    return this.http.get("http://jsonplaceholder.typicode.com/posts/" + postId + "/comments")
                        ...
                        throw error + " : Comment Service error"; });
                };
