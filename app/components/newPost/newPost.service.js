    ...
    return {
        ...
        execute: function() {
            NewPostService = (function () {
                ...
                NewPostService.prototype.addNewPost = function (postObject) {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        _this.http.post('http://jsonplaceholder.typicode.com/posts', JSON.stringify(postObject), { headers: _this.headers })
                            .toPromise()
...
//# sourceMappingURL=newPost.service.js.map